...
// Match slash with spaces (before and after, breaking or not) and not preceded or not followed by another slash.
const rgxSlash = new RegExp(`(?<= | )\\${data.slash}(?!\\${data.slash})|(?<!\\${data.slash})\\${data.slash}(?= | )`, 'gmi');
